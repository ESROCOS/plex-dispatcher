...
const asn1SccContext_test_motioncommanddisapatcherproducer test_motioncommanddisapatcherproducer_ctxt = {
...
flag asn1SccContext_test_motioncommanddisapatcherproducer_IsConstraintValid(const asn1SccContext_test_motioncommanddisapatcherproducer *pVal, int* pErrCode)
{
    ...
    *pErrCode = ret ? 0 :  ERR_CONTEXT_TEST_MOTIONCOMMANDDISAPATCHERPRODUCER_INIT_VAL;
    if (ret) {
        ret = ((-3.40282346600000020000E+038 <= pVal->inc) && (pVal->inc <= 3.40282346600000020000E+038));
        *pErrCode = ret ? 0 :  ERR_CONTEXT_TEST_MOTIONCOMMANDDISAPATCHERPRODUCER_INC;
    }
